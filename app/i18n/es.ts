export const es = {
  ...
  passwordRequirements: 'La contraseña debe tener 8-32 caracteres',
  passwordTooShort: 'La contraseña debe tener al menos 8 caracteres',
  passwordTooLong: 'La contraseña no puede exceder los 32 caracteres',
  ...
  verificationEmailSentTo: 'Enviamos un email de verificación a',
  verificationEmailSent: 'Se ha enviado un email de verificación a tu bandeja de entrada',
  enterVerificationCode: 'Ingresa el código de 6 dígitos',
  didntReceiveEmail: '¿No recibiste el email?',
  resendEmail: 'Reenviar Email',
  resendIn: 'Reenviar en',
  iVerifiedMyEmail: 'Verifiqué mi Email',
  backToLogin: 'Volver al Inicio de Sesión',
  emailVerified: '¡Email verificado exitosamente!',
  emailNotVerified: 'Email no verificado. Por favor revisa tu email.',
  emailNotVerifiedYet: 'Email aún no verificado. Por favor revisa tu bandeja de entrada.',
  verificationError: 'Verificación fallida. Por favor intenta de nuevo.',
  checkEmailError: 'Error al verificar el email.',
  verificationEmailResent: '¡Email de verificación enviado!',
  tooManyRequests: 'Demasiadas solicitudes. Por favor intenta más tarde.',
  resendError: 'Error al reenviar email. Por favor intenta de nuevo.',
  noUserFound: 'Usuario no encontrado. Por favor inicia sesión de nuevo.',
  clickLinkInEmail: 'Haz clic en el enlace de verificación en tu email para verificar tu cuenta.',
  checkYourInbox: 'Revisa tu Bandeja de Entrada',
  cantFindEmail: '¿No encuentras el email?',
